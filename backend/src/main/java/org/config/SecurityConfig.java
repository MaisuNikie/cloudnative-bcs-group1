...
import org.authentication.CookieBearerTokenResolver;
...
public class SecurityConfig {
  ...
  @Bean
  public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, CookieBearerTokenResolver resolver) throws Exception {
    return httpSecurity
